        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                <div class="card-box">
                    ...
                    <div id="morris-bar-example" class="morris-chart" style="height: 280px;"></div>
                </div>
            </div><!-- end col -->
            <div class="col-xl-4">
                <div class="card-box">
                    ...
                    <div id="morris-line-example" class="morris-chart" style="height: 280px;"></div>
                </div>
            </div><!-- end col -->
        </div>
        <!-- end row -->
        <div class="row">
            <div class="col-xl-3 col-md-6">
                <div class="card-box widget-user">
                    <div>
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/users/avatar-3.jpg" class="img-responsive rounded-circle" alt="user">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-box widget-user">
                    <div>
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/users/avatar-2.jpg" class="img-responsive rounded-circle" alt="user">
                        <div class="wid-u-info">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-box widget-user">
                    <div>
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/users/avatar-1.jpg" class="img-responsive rounded-circle" alt="user">
                        <div class="wid-u-info">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-box widget-user">
                    <div>
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/users/avatar-10.jpg" class="img-responsive rounded-circle" alt="user">
                        <div class="wid-u-info">
                    ...
                    <div class="inbox-widget nicescroll" style="height: 315px;">
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/users/avatar-1.jpg" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/users/avatar-2.jpg" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/users/avatar-3.jpg" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/users/avatar-4.jpg" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/users/avatar-5.jpg" class="rounded-circle" alt=""></div>
